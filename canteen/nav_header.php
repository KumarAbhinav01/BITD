...
<header class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow-sm mb-auto" style="background-color: #e43f3f;">
    <div class="container-fluid mx-3">
        <a href="index.php">
            <img src="img/BIT-logo.png" width="75" class="me-2" alt="BITD Cafe">
        </a>
