...
<head>
    ...
    <title>Welcome To BIT Cafe</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to BIT Cafeteria</h1>
            <p class="lead fw-normal">Online Food ordering system BITD Canteen</p>
        </div>
    </div>

    <div class="container p-5" id="recommended-shop">
        <h2 class="border-bottom pb-2"><i class="bi bi-shop align-top"></i> Please Select From Following</h2>
