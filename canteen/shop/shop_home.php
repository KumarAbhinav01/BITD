...
<head>
    ...
    <title>Shop Owner Home | BIT Cafe</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-3">
            ...
            <h1 class="display-5 fw-normal">Welcome to BITD Cafe</h1>
            <p class="lead fw-normal">Online Food ordering system of BITD Canteen</p>
        </div>
    </div>
